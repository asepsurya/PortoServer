...
<section class="portfolio section-padding">
    <div class="container">
        ...
        <div class="d-flex justify-content-center mb-4">
            <ul class="nav nav-pills gap-2 p-2 rounded-pill bg-black shadow-lg d-inline-flex" role="tablist" style="backdrop-filter: blur(6px); border: 1px solid #222;">

                {{-- All --}}
                <li class="nav-item">
                    <a class="nav-link rounded-pill px-4 py-2 fw-semibold
                {{ is_null($currentCategory) ? 'active text-white' : 'text-light' }}" href="{{ $baseUrl }}">
                        All
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link rounded-pill px-4 py-2 fw-semibold
                    {{ $isActive ? 'active text-white' : 'text-light' }}" href="{{ request()->fullUrlWithQuery(['category' => $cat->id]) }}">
                        {{ $cat->name }}
                    </a>
                </li>
                @endforeach
        ...
        <div class="gallery">
            <div class="row">
                ...
                <div class="col-lg-4 items">
                    <div class="item">
                        <div class="img">
                            <img src="{{ $item->image ? asset('storage/' . $item->image) : asset('img/no-signal.jpg') }}" alt="" loading="lazy">
        ...
        <div class="mt-4 d-flex justify-content-center">
            {{ $project->links() }} {{-- ← pagination biasa --}}
        </div>
    </div>
</section>
@endsection
